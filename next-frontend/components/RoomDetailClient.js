    ...
    return (
        <div className="pt-24 pb-24 bg-white font-light">
            <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-16">
                ...
                {/* Back Link */}
                <Link href="/rooms" className="inline-flex items-center gap-4 text-gray-400 hover:text-primary transition-all mb-20 text-[10px] font-bold uppercase tracking-[0.4em] group">
                    <ArrowLeft size={14} className="group-hover:-translate-x-2 transition-all" /> Return to the Collection
                </Link>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 mb-40">
                    ...
                    <div className="lg:col-span-7 space-y-8">
                        <motion.div
                            ...
                            className="aspect-[16/10] relative overflow-hidden luxury-shadow bg-secondary"
                        >
                            <Image
                                src={images[0] || 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&w=800&q=80'}
                                alt={room.name}
                                fill
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            {(images.slice(1, 3).length > 0 ? images.slice(1, 3) : [images[0], images[0]]).map((img, idx) => (
                                <motion.div
                                    ...
                                    className="aspect-[4/3] relative overflow-hidden luxury-shadow"
                                >
                                    <Image
                                        src={img}
                    ...
                    <div className="lg:col-span-5 space-y-16">
                        ...
                        >
                            ...
                            <div className="bg-[#FAF9F6] p-12 luxury-shadow space-y-10">
                                ...
                                <Link
                                    href="/book"
                                    className="bg-secondary text-white py-5 px-8 text-[10px] font-bold uppercase tracking-[0.3em] w-full text-center hover:bg-primary transition-all group flex items-center justify-center gap-4"
                                >
