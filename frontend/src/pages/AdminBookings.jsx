...
import { Search, Filter, Download, MoreVertical, CheckCircle, XCircle, Clock, ExternalLink } from 'lucide-react';
import { fetchAdminBookings, updateBookingStatus } from '../api';
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                <div>
                    <h1 className="text-4xl font-serif text-secondary mb-2 italic">Bookings Management</h1>
            ...
            <div className="bg-white p-6 rounded-sm shadow-sm border border-gray-100 flex flex-col md:flex-row gap-6 justify-between items-center">
                <div className="relative w-full md:max-w-md">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-3 border-gray-100 focus:border-primary focus:ring-0 rounded-sm text-sm placeholder:text-gray-300 transition-all shadow-inner bg-gray-50/30"
                    />
                </div>
                <div className="flex gap-4 w-full md:w-auto">
                    <select
                        ...
                        className="flex-grow md:flex-grow-0 border-gray-100 focus:border-primary focus:ring-0 rounded-sm text-xs px-6 py-3 uppercase tracking-widest font-bold text-gray-500 bg-gray-50/30"
                    >
                                        ...
                                        >
                                            ...
                                            <td className="px-8 py-6 text-right">
                                                <div className="flex justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    ...
                                                    <button
                                                        onClick={() => window.open(`/manage-booking?id=${booking.bookingId}&email=${booking.guestEmail}`, '_blank')}
